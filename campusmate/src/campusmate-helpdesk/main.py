...
A voice-enabled campus helpdesk assistant for students at Kovai Institute of Technology (KIT).
...
def _read_agent_name() -> str:
    try:
        ...
        return m.group(1).strip() if m else "campusmate-helpdesk"
    except Exception:
        return "campusmate-helpdesk"
